...
public class SkyRendererRealm extends IRenderHandler
{
	private static final ResourceLocation sky = new ResourceLocation("realm:/textures/misc/space.png");
	private static final ResourceLocation heatbuff = new ResourceLocation("realm:/textures/misc/heatbuff.png");
	private static final ResourceLocation sun = new ResourceLocation("realm:/textures/misc/sun.png");
	private static final ResourceLocation moon_phases = new ResourceLocation("realm:/textures/misc/space.png");
...
//			GL11.glDisable(GL11.GL_FOG);
			...
			f10 = 30.0F;
			if(Realm.isHeatWave())
				FMLClientHandler.instance().getClient().renderEngine.func_110577_a(heatbuff);
			else
				FMLClientHandler.instance().getClient().renderEngine.func_110577_a(sun);
			...
			tessellator1.draw();
			f10 = 20.0F;
			FMLClientHandler.instance().getClient().renderEngine.func_110577_a(moon_phases);
	...
	private void renderNightSky(float partialTicks)
	{
		...
		RenderHelper.disableStandardItemLighting();
		GL11.glDepthMask(false);
		FMLClientHandler.instance().getClient().renderEngine.func_110577_a(sky);
		Tessellator tessellator = Tessellator.instance;

		GL11.glColor4f(1.0F, 1.0F, 1.0F, (Realm.proxy.getClientWorld().getStarBrightness(partialTicks)) * (1.0F - Realm.proxy.getClientWorld().getRainStrength(partialTicks)));
