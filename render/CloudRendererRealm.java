...
public class CloudRendererRealm extends IRenderHandler {
	
	private static final ResourceLocation clouds = new ResourceLocation("realm:/textures/misc/clouds.png");
			...
			if(!Realm.isHeatWave()){ 
				if (mc.gameSettings.fancyGraphics)
		         ...
		         else
		         {
		             ...
		             FMLClientHandler.instance().getClient().renderEngine.func_110577_a(clouds);
