...
public class RealmBlockLeavesRealmWood extends RealmBlock implements IShearable
{
	...
	public RealmBlockLeavesRealmWood(int id, Material mat)
	{
		super(id, mat);
    ...
    public void randomDisplayTick(World world, int x, int y, int z, Random random)
    {
		...
		{
			RealmEntityFX entityfx = new RealmEntityFX(world, x+random.nextDouble()*2-0.5D, y+random.nextDouble()*2-0.5D, z+random.nextDouble()*2-0.5D, random.nextDouble()/10-0.05D, random.nextDouble()/10-0.05D, random.nextDouble()/10-0.05D);
			entityfx.setRBGColorF(1, 1, 1);
			entityfx.multipleParticleScaleBy(0.25F);
			entityfx.setBrightness(200);
			entityfx.setTextureFile("/mods/realm/textures/misc/particles/fost.png");
    ...
    {
        return Realm.blockSaplingRealmWood.blockID;
    }
...
//            }
    ...
    {
        this.leaves = par1IconRegister.registerIcon(DefaultProps.modId + ":realmwood_leaves");
        this.leaves_fast = par1IconRegister.registerIcon(DefaultProps.modId + ":realmwood_leaves_fast");
