...
public class RealmBlockSaplingRealmWood extends RealmBlockFlower
{
...
//    private Icon[] saplingIcon;
    ...
    public RealmBlockSaplingRealmWood(int par1)
    {
        super(par1);
        float f = 0.4F;
...
//    }
    ...
    public void growTree(World world, int i, int j, int k, Random rand)
    {
        ...
        RealmGenRealmWood RealmWood = new RealmGenRealmWood(Realm.blockLeavesRealmWood.blockID, Realm.blockLogRealmWood.blockID, true);
		
		RealmWood.generate(world, rand, i, j, k);
    }
