...
public abstract class RealmBlockLiquid extends Block
{
    @SideOnly(Side.CLIENT)
    protected Icon[] theIcon;

    protected RealmBlockLiquid(int par1, Material par2Material)
    {
    ...
    public static double getFlowDirection(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, Material par4Material)
    {
        ...
        {
            vec3 = ((RealmBlockLiquid) Realm.waterMoving).getFlowVector(par0IBlockAccess, par1, par2, par3);
        }
...
//        }
    ...
    {
    if(blockID == Realm.waterStill.blockID)
    {
    this.blockIcon = iconRegister.registerIcon("realm:realm_water");
    }
    if(blockID == Realm.waterMoving.blockID)
    {
    this.blockIcon = iconRegister.registerIcon("realm:realm_water_flow");
    }
    }
    ...
    {
        return par0Str == "water" ? Realm.waterMoving.theIcon[0] : Realm.waterMoving.theIcon[1];
    }
}
