...
public class RealmBlockLogRealmWood extends RealmBlock
{
...
//	public static final String[] treeTextureTypes = new String[] {"fostimber_log_side"};
	...
	public RealmBlockLogRealmWood(int id, Material mat)
	{
		super(id, mat);
	}
	...
	{
		this.iconTop = par1IconRegister.registerIcon(DefaultProps.modId + ":realmwood_log_top");
		this.iconSide = par1IconRegister.registerIcon(DefaultProps.modId + ":realmwood_log_side");
	}
