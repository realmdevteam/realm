package mods.realm.dimension;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;
import mods.realm.Realm;
import mods.realm.dimension.gen.ChunkProviderRealm;
import mods.realm.render.CloudRendererRealm;
import mods.realm.render.SkyRendererRealm;
...
public class RealmWorldProvider extends WorldProvider
{
	...
	{
		this.worldChunkMgr = new RealmChunkManager(this.worldObj);
		this.dimensionId = Realm.DimensionID;
		this.hasNoSky = false;
		
		if(worldObj.isRemote)
		{
			this.setSkyRenderer(new SkyRendererRealm());
			this.setCloudRenderer(new CloudRendererRealm());
		}
	}
	...
	{
		return new ChunkProviderRealm(this.worldObj, this.worldObj.getSeed());
	}
