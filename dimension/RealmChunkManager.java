...
public class RealmChunkManager extends WorldChunkManager
{
	...
	protected RealmChunkManager()
	{
		this.allowedBiomes.clear();
		this.allowedBiomes.add(Realm.biomePlain);
		this.allowedBiomes.add(Realm.biomePlain);
		this.allowedBiomes.add(Realm.biomeOcean);
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList();
		this.biomesToSpawnIn.addAll(allowedBiomes);
	}

	public RealmChunkManager(long par1, WorldType par3WorldType)
	{
		this();
	...
	public RealmChunkManager(World par1World)
	{
