...
public class RealmGenRealmWood extends WorldGenerator
{
	int leavesId,logId;
	boolean fromSapling;
	
	public RealmGenRealmWood(int leavesId, int logId, boolean fromSapling)
	{
		super(fromSapling);
	...
	public boolean generate(World world, Random random, int x, int y, int z)
	{
		...
		int h5 = treeHeight - random.nextInt(2);
		int h6 = treeHeight - random.nextInt(2);
		int h7 = treeHeight - random.nextInt(2);
		int h8 = treeHeight - random.nextInt(2);
