...
import mods.realm.api.temperature.IBlockHeatable;
import mods.realm.api.temperature.TemperatureManager;
import net.minecraft.block.Block;
import net.minecraft.util.MathHelper;
import net.minecraft.world.World;

public class RealmGenMinable
{
	...
	public RealmGenMinable(int id, int amount)
	{
		this(id, amount, Realm.blockGreatstone.blockID);
	}

	public RealmGenMinable(int id, int amount, int target)
	{
	...
	public RealmGenMinable(int id, int meta, int amount, int target)
	{
